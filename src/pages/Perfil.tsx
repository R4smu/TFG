  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white p-8 transition-colors duration-300">
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        {esadmin && (
          <div className="mt-12 animate-fade-in border-t border-gray-200 dark:border-gray-800 pt-8 transition-colors">
            <h3 className="text-xl font-bold text-purple-600 dark:text-purple-400 mb-6 uppercase tracking-wider text-sm flex items-center gap-2">
