...
export default function Perfil({ esadmin }: PerfilProps) {
  ...
  if (cargando) {
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-950 flex flex-col justify-center items-center transition-colors duration-300">
            ...
            {mostrarAjustes ? (
              ...
              <div className="animate-fade-in">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-gray-50 dark:bg-gray-800/50 p-6 rounded-xl border border-gray-100 dark:border-gray-800 transition-colors">
                    <p className="text-xs text-gray-500 dark:text-gray-400 mb-1 font-medium">Correo Electrónico</p>
                    <p className="font-bold text-gray-900 dark:text-white text-xl">{usuario.email}</p>
                  </div>
                  <div className="bg-gray-50 dark:bg-gray-800/50 p-6 rounded-xl border border-gray-100 dark:border-gray-800 transition-colors">
                    <p className="text-xs text-gray-500 dark:text-gray-400 mb-1 font-medium">Número de Teléfono</p>
                    <p className="font-bold text-gray-900 dark:text-white text-xl">{usuario.telefono || 'No especificado'}</p>
                  </div>
                </div>
              </div>
            )}
